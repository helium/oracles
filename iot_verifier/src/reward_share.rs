...
lazy_static! {
    ...
    static ref REWARDS_PER_DAY: Decimal = (Decimal::from(32_500_000_000_u64) / Decimal::from(365)) * Decimal::from(1_000_000); //  89_041_095_890_410.5
...
mod test {
    ...
    fn test_non_gateway_reward_shares() {
        ...
        assert_eq!(259_703_196_347, operation_tokens_for_period);
    }
