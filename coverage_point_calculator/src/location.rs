...
pub mod service_provider_boosting {
    use super::*;
    ...
    ///
    /// Reference: HIP-93
    /// https://github.com/helium/HIP/blob/main/0093-addition-of-wifi-aps-to-mobile-subdao.md#341-indoor-access-points-rewards
    pub const MIN_WIFI_TRUST_MULTIPLIER: Decimal = dec!(0.75);
    ...
    ///
    /// Reference: HIP-119
    /// https://github.com/helium/HIP/blob/main/0119-closing-gaming-loopholes-within-the-mobile-network.md#maximum-asserted-distance-for-boosted-hexes
    pub const MAX_AVERAGE_DISTANCE: Decimal = dec!(50);
}
