...
pub mod playground {
    ...
    use crate::sp_promotions::{
        funds_db::ServiceProviderFunds, ServiceProviderPromotionRewardShares,
    };

    use super::{dc_to_mobile_bones, ServiceProviderDCSessions, DEFAULT_PREC};
    mod proto {
    ...
    #[derive(Debug)]
    pub struct ServiceProvideRewardInfoColl {
        coll: Vec<ServiceProvideRewardInfo>,
    ...
    pub struct ServiceProvideRewardInfo {
    ...
    impl ServiceProvideRewardInfoColl {
        pub fn new(
            ...
            for (dc_session, dc_transfer) in dc_sessions.iter() {
                ...
                me.coll.push(ServiceProvideRewardInfo::new(
                    dc_session,
                    dc_transfer,
                    promo_fund_perc,
                    used_allocation,
    ...
    fn distribute_unallocated(coll: &mut [ServiceProvideRewardInfo]) {
    ...
    fn distribute_unalloc_over_limit(
        coll: &mut [ServiceProvideRewardInfo],
        unallocated_perc: Decimal,
    ) {
    ...
    fn distribute_unalloc_under_limit(coll: &mut [ServiceProvideRewardInfo]) {
        for sp in coll.iter_mut() {
            if sp.rewards.is_empty() {
                continue;
            }
    ...
    mod tests {
        ...
        fn get_unallocated_percent(sps: &ServiceProvideRewardInfoColl) -> Decimal {
        ...
        fn test_multiple_with_reward() {
            ...
            let sps = ServiceProvideRewardInfoColl::new(
        ...
        fn test_multiple_no_reward() {
            ...
            let mut sps = ServiceProvideRewardInfoColl::new(
                ServiceProviderDCSessions(dc_sessions),
                ServiceProviderFunds(promo_funds),
                vec![],
                total_allocation,
        ...
        fn over_limit_with_rewards() {
            let promo_0 = ServiceProviderPromotionRewardShares {
                service_provider_id: 0,
            ...
            let promo_1 = ServiceProviderPromotionRewardShares {
                service_provider_id: 0,
                rewardable_entity: file_store::promotion_reward::Entity::SubscriberId(
                    uuid::Uuid::new_v4().into(),
                ),
            ...
            let expected_one = ServiceProvideRewardInfo {
                sp_id: 0,
                dc: dec!(200),
            ...
            let one =
                ServiceProvideRewardInfo::new(0, dec!(200), dec!(0.2), dec!(1000), vec![promo_0]);
            let two =
                ServiceProvideRewardInfo::new(1, dec!(200), dec!(0.4), dec!(1000), vec![promo_1]);
        ...
        fn over_limit_no_rewards() {
            ...
            let one = ServiceProvideRewardInfo::new(0, dec!(200), dec!(0.2), dec!(1000), vec![]);
            let two = ServiceProvideRewardInfo::new(1, dec!(200), dec!(0.4), dec!(1000), vec![]);
...
pub struct ServiceProviderDCSessions(HashMap<i32, Decimal>);
...
impl ServiceProviderDCSessions {
    ...
    pub fn insert(&mut self, service_provider: i32, dc: Decimal) {
    ...
    pub fn iter(&self) -> impl Iterator<Item = (i32, Decimal)> + '_ {
...
impl ServiceProviderShares {
    ...
    pub async fn from_payers_dc(
        ...
        _promo_funds: ServiceProviderFunds,
        ...
        for (payer, total_dcs) in payer_shares {
            ...
            // let promo_fund_perc =
            // promo_funds.fetch_incentive_escrow_fund_percent(service_provider as i32);
    ...
    pub fn into_service_provider_rewards(
        ...
        for share in self.shares.into_iter() {
            ...
            let percent_for_promotion_rewards =
                service_provider_funds.get_fund_percent(share.service_provider as i32);
