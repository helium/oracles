...
async fn test_save_wifi_coverage_object(pool: PgPool) -> anyhow::Result<()> {
    ...
    let co = file_store_helium_proto::coverage::CoverageObject {
        pub_key: PublicKeyBinary::from(vec![1]),
        uuid,
        key_type: file_store_helium_proto::coverage::KeyType::HotspotKey(
        ...
        coverage_claim_time,
        coverage: vec![
            file_store_helium_proto::coverage::RadioHexSignalLevel {
...
async fn test_coverage_object_save_updates(pool: PgPool) -> anyhow::Result<()> {
    ...
    let co1 = file_store_helium_proto::coverage::CoverageObject {
        pub_key: PublicKeyBinary::from(vec![1]),
        uuid,
        key_type: file_store_helium_proto::coverage::KeyType::HotspotKey(bkey.clone()),
        coverage_claim_time,
        coverage: vec![file_store_helium_proto::coverage::RadioHexSignalLevel {
            location: "8a1fb46622dffff".parse().unwrap(),
            signal_level: SignalLevel::High,
            signal_power: 1000,
        }],
    ...
    let co2 = file_store_helium_proto::coverage::CoverageObject {
        pub_key: PublicKeyBinary::from(vec![1]),
        uuid,
        key_type: file_store_helium_proto::coverage::KeyType::HotspotKey(bkey),
        coverage_claim_time,
        coverage: vec![file_store_helium_proto::coverage::RadioHexSignalLevel {
            location: "8a1fb46622dffff".parse().unwrap(),
...
async fn scenario_one(pool: PgPool) -> anyhow::Result<()> {
    ...
    let coverage_object = CoverageObjectIngestReport {
        ...
        report: file_store_helium_proto::coverage::CoverageObject {
            pub_key: pub_key.clone(),
            uuid,
            key_type: file_store_helium_proto::coverage::KeyType::HotspotKey(pub_key.clone()),
...
async fn scenario_two(pool: PgPool) -> anyhow::Result<()> {
    ...
    let coverage_object_1 = CoverageObjectIngestReport {
        ...
        report: file_store_helium_proto::coverage::CoverageObject {
            pub_key: PublicKeyBinary::from(vec![1]),
            uuid: uuid_1,
            key_type: file_store_helium_proto::coverage::KeyType::HotspotKey(hs_pubkey_1.clone()),
            // older then in co2
            coverage_claim_time: "2022-01-01 00:00:00.000000000 UTC".parse()?,
            indoor: false,
            signature: Vec::new(),
    ...
    let coverage_object_2 = CoverageObjectIngestReport {
        ...
        report: file_store_helium_proto::coverage::CoverageObject {
            pub_key: PublicKeyBinary::from(vec![1]),
            uuid: uuid_2,
            key_type: file_store_helium_proto::coverage::KeyType::HotspotKey(hs_pubkey_2.clone()),
...
async fn scenario_three(pool: PgPool) -> anyhow::Result<()> {
    ...
    let coverage_object_1 = CoverageObjectIngestReport {
        ...
        report: file_store_helium_proto::coverage::CoverageObject {
            pub_key: PublicKeyBinary::from(vec![1]),
            uuid: uuid_1,
            key_type: file_store_helium_proto::coverage::KeyType::HotspotKey(hs_pub_key_1.clone()),
    ...
    let coverage_object_2 = CoverageObjectIngestReport {
        ...
        report: file_store_helium_proto::coverage::CoverageObject {
            pub_key: PublicKeyBinary::from(vec![1]),
            uuid: uuid_2,
            key_type: file_store_helium_proto::coverage::KeyType::HotspotKey(hs_pub_key_2.clone()),
    ...
    let coverage_object_3 = CoverageObjectIngestReport {
        ...
        report: file_store_helium_proto::coverage::CoverageObject {
            pub_key: PublicKeyBinary::from(vec![1]),
            uuid: uuid_3,
            key_type: file_store_helium_proto::coverage::KeyType::HotspotKey(hs_pub_key_3.clone()),
    ...
    let coverage_object_4 = CoverageObjectIngestReport {
        ...
        report: file_store_helium_proto::coverage::CoverageObject {
            pub_key: PublicKeyBinary::from(vec![1]),
            uuid: uuid_4,
            key_type: file_store_helium_proto::coverage::KeyType::HotspotKey(hs_pub_key_4.clone()),
    ...
    let coverage_object_5 = CoverageObjectIngestReport {
        ...
        report: file_store_helium_proto::coverage::CoverageObject {
            pub_key: PublicKeyBinary::from(vec![1]),
            uuid: uuid_5,
            key_type: file_store_helium_proto::coverage::KeyType::HotspotKey(hs_pub_key_5.clone()),
...
async fn scenario_four(pool: PgPool) -> anyhow::Result<()> {
    ...
    let coverage_object_1 = CoverageObjectIngestReport {
        ...
        report: file_store_helium_proto::coverage::CoverageObject {
            ...
            uuid: uuid_1,
            key_type: file_store_helium_proto::coverage::KeyType::HotspotKey(pub_key_1.clone()),
            coverage_claim_time: "2022-01-01 00:00:00.000000000 UTC".parse()?,
            indoor: true,
            signature: Vec::new(),
    ...
    let coverage_object_2 = CoverageObjectIngestReport {
        ...
        report: file_store_helium_proto::coverage::CoverageObject {
            ...
            uuid: uuid_2,
            key_type: file_store_helium_proto::coverage::KeyType::HotspotKey(pub_key_2.clone()),
...
async fn ensure_lower_trust_score_for_distant_heartbeats(pool: PgPool) -> anyhow::Result<()> {
    ...
    let coverage_object = file_store_helium_proto::coverage::CoverageObject {
        pub_key: PublicKeyBinary::from(vec![1]),
        uuid: coverage_object_uuid,
        key_type: file_store_helium_proto::coverage::KeyType::HotspotKey(owner_1.clone()),
        coverage_claim_time: "2022-02-01 00:00:00.000000000 UTC".parse()?,
        indoor: true,
        signature: Vec::new(),
...
async fn eligible_for_coverage_map_bad_speedtest(pool: PgPool) -> anyhow::Result<()> {
    ...
    let coverage_object_1 = CoverageObjectIngestReport {
        ...
        report: file_store_helium_proto::coverage::CoverageObject {
            ...
            uuid: uuid_1,
            key_type: file_store_helium_proto::coverage::KeyType::HotspotKey(good_hotspot.clone()),
