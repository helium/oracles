use clap::Parser;
use poc_injector::{server::Server, Result};
...
#[clap(about = "Helium POC Injector Server")]
pub struct Cli {}
...
async fn main() -> Result {
    ...
    tracing_subscriber::registry()
        .with(tracing_subscriber::EnvFilter::new(
            dotenv::var("RUST_LOG").unwrap_or_else(|_| "poc_injector=debug".into()),
        ))
    ...
    let injector_keypair = poc_injector::keypair::load_from_file(&injector_kp_path)?;
